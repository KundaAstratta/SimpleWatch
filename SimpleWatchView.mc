...
class SimpleWatchView extends Ui.WatchFace {
   ...
   //angle adjust for time hands
    ...
    function onUpdate(dc) {
	  ...
	  // arcs' color
	  var color_arc = Gfx.COLOR_YELLOW;
	  var colorProperties = App.getApp().getProperty("ArcColor") ;
      color_arc = returnColor(colorProperties); 
	
	  
	  
	   dc.setColor(color_arc, Gfx.COLOR_TRANSPARENT);    
